...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-version3 --enable-gpl --enable-nonfree --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-devices --disable-protocols --enable-protocol=file --enable-avfilter --disable-network --disable-mpegaudio-hp --disable-avdevice --enable-cross-compile --cc=/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc --cross-prefix=/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi- --nm=/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-nm --extra-cflags='-fPIC -DANDROID' --disable-asm --enable-neon --enable-armv5te --extra-ldflags='-Wl,-T,/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/home/uday/mount/android-ndk-r4b/build/platforms/android-8/arch-arm/usr/lib -L/home/uday/mount/android-ndk-r4b/build/platforms/android-8/arch-arm/usr/lib -nostdlib /home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl'
prefix=/usr/local
...
SRC_PATH="/home/uday/mount/workspace/ffmpeg-shared/jni/ffmpeg"
SRC_PATH_BARE=/home/uday/mount/workspace/ffmpeg-shared/jni/ffmpeg
BUILD_ROOT="/home/uday/mount/workspace/ffmpeg-shared/jni/ffmpeg"
ARCH=c
CC=/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
AS=/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
LD=/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
DEPCC=/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-ar
RANLIB=/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
...
CC_O=-o $@
LDFLAGS=  -Wl,-T,/home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/home/uday/mount/android-ndk-r4b/build/platforms/android-8/arch-arm/usr/lib -L/home/uday/mount/android-ndk-r4b/build/platforms/android-8/arch-arm/usr/lib -nostdlib /home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /home/uday/mount/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
